...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
	if(htim == &htim3)
	{
		...
		apply_pid(&pid_pitch, 0 - euler_angles_robot.pitch);
//		set_motor_voltage(&motor_drone, MOTOR_1, 30.0 + pid_pitch.output);
//		set_motor_voltage(&motor_drone, MOTOR_2, 30.0 + pid_pitch.output);
//		set_motor_voltage(&motor_drone, MOTOR_3, 30.0 - pid_pitch.output);
//		set_motor_voltage(&motor_drone, MOTOR_4, 30.0 - pid_pitch.output);
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
  HAL_Delay(1000);
  lsm6dsr_init(&imu_sensor, 1000);
  HAL_TIM_Base_Start_IT(&htim3);
//  set_motor_voltage(&motor_drone, MOTOR_1, 20.0);
//  set_motor_voltage(&motor_drone, MOTOR_2, 20.0);
//  set_motor_voltage(&motor_drone, MOTOR_3, 20.0);
//  set_motor_voltage(&motor_drone, MOTOR_4, 20.0);
//  uint8_t temp_data = 0x0f|0x80;
//  HAL_GPIO_WritePin(LSM6DSR_CS_GPIO_Port, LSM6DSR_CS_Pin,
//  			GPIO_PIN_RESET);
//  HAL_SPI_Transmit(&hspi2, &temp_data , 1, 100);
//  HAL_SPI_Receive(&hspi2, &temp_data, 1, 100);
//  HAL_GPIO_WritePin(LSM6DSR_CS_GPIO_Port, LSM6DSR_CS_Pin,
//    			GPIO_PIN_SET);
  /* USER CODE END 2 */
